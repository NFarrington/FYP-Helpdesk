    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <ul class="list-inline list-unstyled">
                <li class="col-md-2" style="margin-bottom: 10px;">
                    <label>{{ __('ticket.key.user') }}</label><br>{{ $ticket->user->name }}</li>
                <li class="col-md-2" style="margin-bottom: 10px;">
                    <label>{{ __('ticket.key.department') }}</label><br>{{ $ticket->department->name }}</li>
                <li class="col-md-2" style="margin-bottom: 10px;">
                    <label>{{ __('ticket.key.agent') }}</label><br>{{ $ticket->agent->name ?? 'None' }}</li>
                <li class="col-md-2" style="margin-bottom: 10px;">
